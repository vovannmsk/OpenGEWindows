...
namespace OpenGEWindows
{
    ...
    public class ServerAmerica2 : Server
    {
        ...
        public ServerAmerica2(botWindow botwindow)
        {
            ...
            this.pointSteamLogin1 = new Point(980, 455); //для Стима используются абсолютные координаты
            this.pointSteamLogin2 = new Point(840, 455); //для Стима используются абсолютные координаты
            ...
            this.pointisContinueRunning1 = new PointColor(861, 551, 14471368, 0); //для Стима используются абсолютные координаты
            this.pointisContinueRunning2 = new PointColor(862, 551, 14471368, 0); //для Стима используются абсолютные координаты
            ...
            this.pointTeleportFirstLine =        new Point(400 + xx, 178 + yy);   //400, 193               тыкаем в первую строчку телепорта                          //проверено
            //this.pointTeleportSecondLine = new Point(400 + xx, 193 + yy);   //              тыкаем во вторую строчку телепорта                          //проверено
            this.pointTeleportExecute = new Point(355 + xx, 580 + yy);   //             тыкаем в кнопку Execute                   //проверено
...
//            int[] MenukoordX = { 283, 316, 349, 382, 415, 453, 500, 547, 588, 620, 653, 683, 715, 748 };
        ...
        //{
        //    return FindWindow("Sandbox:" + botwindow.getNumberWindow().ToString() + ":vguiPopupWindow", "Steam");
        //}
