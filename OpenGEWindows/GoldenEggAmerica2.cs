...
{
    public class GoldenEggAmerica2 : GoldenEgg
    {

        public GoldenEggAmerica2 ()
        {}

        public GoldenEggAmerica2 (botWindow botwindow)
        {
            #region общие
        ...
        {
            int[] routeTime = { 10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000 };
