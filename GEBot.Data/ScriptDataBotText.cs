...
namespace GEBot.Data
{
    public class ScriptDataBotText : IScriptDataBot
    {
        ...
        private int Koord_X()
        {
            int[] koordX = { 5, 30, 55, 80, 105, 130, 155, 180, 205, 230, 255, 280, 305, 875, 850, 825, 800, 775, 5, 875 };
   //         int[] koordX = { 5, 30, 55, 80, 105, 130, 155, 180, 205, 230, 5, 280, 305, 875, 850, 825, 800, 775, 5, 875 };
        ...
        {
            int[] koordY = { 5, 30, 55, 80, 105, 130, 155, 180, 205, 230, 255, 280, 305, 5, 30, 55, 80, 105, 5, 5 };
    //        int[] koordY = { 5, 30, 55, 80, 105, 130, 155, 180, 205, 230, 5, 280, 305, 5, 30, 55, 80, 105, 5, 5 };
