...
namespace GEBot.Data
{
    public class ScriptDataBotText : IScriptDataBot
    {
        ...
        private int Koord_X()
        {
            ...
            //int[] koordX = { 5, 30, 55, 80, 105, 130, 155, 180, 205, 5, 255, 280, 305, 875, 850, 825, 800, 775, 5, 875 };
        ...
        private int Koord_Y()   // каталог и номер окна
        {
            ...
            //int[] koordY = { 5, 30, 55, 80, 105, 130, 155, 180, 205, 5, 255, 280, 305, 875, 850, 825, 800, 775, 5, 875 };
