...
namespace States
{
    public class StateGT74 : IState
    {
        ...
        public StateGT74(botWindow botwindow)   //, GotoTrade gototrade)
        {
        ...
        {
            return new StateGT75(botwindow);
        }
        ...
        {
            return new StateGT74(botwindow);
        }
