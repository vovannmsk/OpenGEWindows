...
namespace States
{
    public class StateGT22 : IState
    {
        ...
        public StateGT22(botWindow botwindow)   //, GotoTrade gototrade)
        {
        ...
        {
            return new StateGT23(botwindow);
        }
        ...
        public IState StatePrev()         // возвращает запасное состояние, если переход не осуществился
        {
            ...
            else
            {
                ...
                else { return new StateGT01(botwindow); }           // если кто-то из героев убит, то присваиваем конечное состояние, а именно GT01, чтобы на следующем круге реанимировать бота
            }
        }
