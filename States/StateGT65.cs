...
namespace States
{
    public class StateGT65 : IState
    {
        ...
        public StateGT65(botWindow botwindow)   //, GotoTrade gototrade)
        {
            this.botwindow = botwindow;        //методы бота
...
//            this.botwindowDealer = new botWindow(20);         // здесь методы торговца как у обычного бота
        ...
        {
            return new StateGT65(botwindow);
        }
