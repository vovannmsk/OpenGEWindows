...
namespace States
{
    public class StateCV08 : IState
    {
        ...
        public StateCV08(botWindow botwindow, botMerchant dealer)
        {
        ...
        public StateCV08(botWindow botwindow, botWindow botwindowDealer)
        {
...
//            this.dealer = new botMerchant(botwindowDealer);  //делаем торговца
        ...
        /// <summary>
        /// метод осуществляет действия для перехода к запасному состоянию, если не удался переход из состояния GT08 в GT08
        /// </summary>
        public void elseRun()
        {
        ...
        {
            return new StateCV09(botwindow, dealer);
        }
