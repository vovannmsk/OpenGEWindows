...
namespace States
{
    public class StateGT06 : IState
    {
        ...
        public StateGT06(botWindow botwindow)   //, GotoTrade gototrade)
        {
        ...
        /// <summary>
        /// метод осуществляет действия для перехода из состояния GT06 в GT07
        /// </summary>
        ...
        /// <summary>
        /// метод осуществляет действия для перехода к запасному состоянию, если не удался переход из состояния GT06 в GT07
        /// </summary>
        public void elseRun()
        {
        ...
        {
            return new StateGT07(botwindow);  //, gototrade);
        }
