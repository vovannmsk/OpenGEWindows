...
namespace States
{
    public class StateGTI75 : IState
    {
        ...
        public StateGTI75(botWindow botwindow, int numberOfEquipvent)   //, GotoTrade gototrade)
        {
        ...
        {
            return new StateGTI75(botwindow, this.numberOfEquipvent);
        }
