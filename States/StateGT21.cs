...
namespace States
{
    public class StateGT21 : IState
    {
        ...
        public StateGT21(botWindow botwindow)   //, GotoTrade gototrade)
        {
        ...
        {
            return new StateGT22(botwindow);
        }
        ...
        public IState StatePrev()         // возвращает запасное состояние, если переход не осуществился
        {
            ...
            else
            {
                ...
                else { return new StateGT01(botwindow); }           // если кто-то из героев убит присваиваем конечное состояние, а именно GT01, чтобы на следующем круге реанимировать бота
            }
        }
