...
namespace States
{
    public class StateGT016b : IState
    {
        ...
        public StateGT016b(botWindow botwindow)   //, GotoTrade gototrade)
        {
        ...
        {
            return !town.isOpenTownTeleport();                //если нет городского телепорта, значит телепортация состоялась и бот уже на торговой улице
        }
        ...
        {
            return new StateGT016c(botwindow);
        }
