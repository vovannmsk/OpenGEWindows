...
namespace States
{
    public class StateGTI72 : IState
    {
        ...
        public StateGTI72(botWindow botwindow, int numberOfEquipvent)   //, GotoTrade gototrade)
        {
        ...
        {
            return server.isGoodChipArmor();         //если получился хороший чип, то идём далее 
        }
