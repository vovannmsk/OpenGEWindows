...
namespace States
{
    public class StateCV10 : IState
    {
        ...
        public StateCV10(botWindow botwindow, botMerchant dealer)
        {
        ...
        public StateCV10(botWindow botwindow, botWindow botwindowDealer)
        {
        ...
        /// <summary>
        /// метод осуществляет действия для перехода из состояния GT10 в GT02
        /// </summary>
        ...
        /// <summary>
        /// метод осуществляет действия для перехода к запасному состоянию, если не удался переход из состояния GT10 в GT02
        /// </summary>
        public void elseRun()
        {
