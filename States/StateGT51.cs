...
namespace States
{
    public class StateGT51 : IState
    {
        ...
        public StateGT51(botWindow botwindow)   //, GotoTrade gototrade)
        {
        ...
        {
            if (!server.isActivePet()) server.ActivePet();
        ...
        {
            return (!server.isKillHero() && server.isActivePet());     //если никто не убит и активирован пет, то дальше
        ...
        {
            return new StateGT52(botwindow);
        }
        ...
        public IState StatePrev()         // возвращает запасное состояние, если переход не осуществился
        {
            ...
            else
            {
                ...
                else { return new StateGT58(botwindow); }           // если кто-то из героев убит, то присваиваем конечное состояние, а именно GT01, чтобы на следующем круге реанимировать бота
            }
        }
