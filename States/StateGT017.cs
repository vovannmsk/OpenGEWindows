...
namespace States
{
    public class StateGT017 : IState
    {
        ...
        public StateGT017(botWindow botwindow)   //, GotoTrade gototrade)
        {
...
//            server.Teleport(1);                       // телепорт на работу   
        ...
        public IState StatePrev()         // возвращает запасное состояние, если переход не осуществился
        {
            ...
            else
            {
                ...
                { return new StateGT028(botwindow); }     //последнее состояние движка, чтобы движок сразу тормознулся}
                else return this;
            }
        }
