...
namespace States
{
    public class StateCV09 : IState
    {
        ...
        public StateCV09(botWindow botwindow, botMerchant dealer)
        {
        ...
        public StateCV09(botWindow botwindow, botWindow botwindowDealer)
        {
...
//            this.dealer = new botMerchant(botwindowDealer);  //делаем торговца
        ...
        {
            return new StateCV10(botwindow, dealer);
        }
