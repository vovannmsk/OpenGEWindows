...
namespace States
{
    public class StateGTI70 : IState
    {
        ...
        public StateGTI70(botWindow botwindow, int numberOfEquipvent)   //, GotoTrade gototrade)
        {
        ...
        {
            return new StateGTI70(botwindow, this.numberOfEquipvent);
        }
