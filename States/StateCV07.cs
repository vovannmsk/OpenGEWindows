...
namespace States
{
    public class StateCV07 : IState
    {
        ...
        public StateCV07(botWindow botwindow, botMerchant dealer)
        {
        ...
        public StateCV07(botWindow botwindow, botWindow botwindowDealer)
        {
...
//            this.dealer = new botMerchant(botwindowDealer);  //делаем торговца
        ...
        /// <summary>
        /// метод осуществляет действия для перехода к запасному состоянию, если не удался переход из состояния GT07 в GT07
        /// </summary>
        public void elseRun()
        {
