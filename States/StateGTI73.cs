...
namespace States
{
    public class StateGTI73 : IState
    {
        ...
        public StateGTI73(botWindow botwindow, int numberOfEquipvent)   //, GotoTrade gototrade)
        {
        ...
        {
            return new StateGTI73(botwindow, this.numberOfEquipvent);
        }
