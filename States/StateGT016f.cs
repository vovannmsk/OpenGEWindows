...
namespace States
{
    public class StateGT016f : IState
    {
        ...
        public StateGT016f(botWindow botwindow) 
        {
        ...
        {
            return dialog.isDialog();              //зашли в автомат патронов
        }
        ...
        {
            return new StateGT016g(botwindow);
        }
        ...
        {
            return this;                                                                                         //сделать переход в конец цикла
        }
